  ...
  const CommentItem = ({ comment }: { comment: any }) => (
    <div className="flex gap-3 group">
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-gray-50 hover:bg-gray-100 transition-colors rounded-2xl px-4 py-3">
    ...
    <div className="border-t border-gray-100 pt-4 mt-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <Button
          ...
          className="flex items-center gap-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors -ml-2"
        >
          <svg
            className="w-5 h-5"
            fill="none"
            ...
            <div className="flex-1 space-y-2">
              <div className="flex gap-2">
                <Input
                  name="fullName"
                  type="text"
                  className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all"
                ...
                <Button
                  ...
                  className="rounded-2xl px-6 py-3 min-w-[80px]"
                >
                  Enviar
                </Button>
              </div>
